...
//
//        Toast.makeText(this, "zhunbeiqidong", Toast.LENGTH_SHORT).show();
////        mLocationClient.start();
//        startService(new Intent(getBaseContext(), MyService.class));
////        Toast.makeText(this, "服务已经启动", Toast.LENGTH_LONG).show();

        if(MyService.service == null){
        Toast.makeText(this, "MyService.service == null", Toast.LENGTH_LONG).show();
            MyService.service = new Intent(getBaseContext(), MyService.class);
            startService(MyService.service);
        }
